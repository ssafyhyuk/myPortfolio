...
<div class="main-container">
    ...
    <select v-model="selectedCategory" @change="handleCategoryChange" class="select">
        ...
        <option v-for="category in store.savingproducts" :key="category.id" :value="category.kor_co_nm">
        {{ category.kor_co_nm }}
        </option>
    </select>
...
return store.savingproducts.filter(product => product.kor_co_nm === selectedCategory.value);
});
