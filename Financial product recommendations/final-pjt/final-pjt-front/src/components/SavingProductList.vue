<template>
    <div v-if="product" class="product-container">
        <div class="product-header">
            ...
            <router-link :to="{ name: 'savingproductdetail', params: { str: product.fin_prdt_cd }}" class="product-name">
                {{ product.fin_prdt_nm }}
            </router-link>
        </div>
...
const fetchOptions = () => {
    axios({
        method: 'get',
        url: `${store.API_URL}/products/saving-products/options/${product.fin_prdt_cd}/`,
        headers: {
